...
export default function QuartierSelectorToggler({
  ...
  return (
    <div
      className="lg:w-278px lg:py-12px flex grow cursor-pointer items-center justify-center border"
      onClick={toggleOpen}
    >
...
function ArrowUp() {
  return (
    <svg
      viewBox="0 0 14 10"
      className="lg:h-14px lg:w-19px h-[14px] w-[10px] stroke-retro-black"
      fill="none"
