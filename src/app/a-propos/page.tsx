    ...
    <div>
      ...
      <div>
        <Contributeur>
          ...
          <Film name="Ma Nuit chez Maud" inLink="/film/nuit-chez-maud-1969" />,{" "}
          <Film name="Printemps Tardif" inLink="/film/printemps-tardif-1949" />
        ...
        <Contributeur>
          ...
          <Film name="Marie-Antoinette" inLink="/film/marie-antoinette-2006" />
        </Contributeur>
        <Contributeur>
        ...
        <Contributeur>
          ...
          <br />
          <span className="font-semibold uppercase">designer graphique</span>
          <br />
