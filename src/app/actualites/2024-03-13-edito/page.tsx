...
export default function Page() {
  return (
    <ArticleLayout info={info}>
      <MiddleColumn>
        <BodyCopy>
          Aujourd’hui débute le festival de la Cinémathèque française, organisé
          au sein même de la fameuse institution mais également dans plusieurs
          autres salles de la capitale. Peter Weir est l’invité d’honneur de
          cette édition. La sélection est également composée d’une magnifique
          ...
          cinématographique. Au-delà de l’évident enjeu de conservation de vieux
          films (pour lequel la Cinémathèque fait un travail unique et
          précieux), la question posée est celle du rapport entretenu au présent
          avec ce cinéma du passé. Nous avons créé Le Rétro Projecteur
