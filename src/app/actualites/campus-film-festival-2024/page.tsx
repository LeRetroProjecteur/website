    ...
    <>
      ...
      <ThreeColumnLayout>
        ...
        <MiddleColumn>
          <BodyCopy>
            <strong>
              Le Campus Film Festival début ce vendredi 26 avril au cinéma
              Saint-André des Arts. Vous pouvez découvrir les séances du Campus
              Film Festival{" "}
              <a
                target="_blank"
                className="underline"
                href="https://campusfilmfestival.fr/events/"
              >
                ici
              </a>
              . En attendant le lancement, nous avons rencontré Marine Wagner,
              qui fait partie des organisateurs du festival.
            </strong>
          </BodyCopy>
          <BodyCopy>
            ...
            <Answer>
              Lors de la première édition, qui a eu lieu en mai 2023 au cinéma
              Saint-André des Arts, nous avons mis en avant des films abordant
              le thème de la jeunesse et du passage à l&apos;âge adulte.
              <br />
              Pour cette seconde édition, nous avons souhaité élargir notre
              programmation en explorant les thèmes du rêve, de l&apos;onirisme
              et des aspirations profondes de la jeunesse. La sélection combine
              classiques intemporels et récits contemporains. Léa Mysius nous
              fait l’honneur d’être la marraine de notre festival et présentera
              son film{" "}
              ...
              <br />
              Le festival débute vendredi avec plusieurs événements&nbsp;: la
              projection de{" "}
              <Link className="underline" href="/film/peggy-sue-mariee-1986">
                <i>Peggy Sue s’est mariée</i>
              </Link>{" "}
              (1986) de Francis Ford Coppola à 20h, présentée par la drag-queen
              Babouchka Babouche. La séance sera suivie d’une soirée blind-test
              animée par cette dernière ainsi que des DJ sets. Nous accueillons
              également le collectif d’artistes Artemisiae dès le vendredi 26
              avril qui exposeront leurs œuvres dans le hall du Saint André des
              Arts situé rue Gît-le-cœur. Notre sélection comprend également des
              films d’horreur (
              ...
              de Robert Altman.
              <br />
              En sélectionnant ces films et d&apos;autres encore, nous avons
              cherché à créer un programme diversifié et équilibré, offrant
              quelque chose pour tous les goûts et toutes les sensibilités.
              Notre objectif était de susciter la réflexion, l&apos;émotion et
