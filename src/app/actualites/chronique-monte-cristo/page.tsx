      ...
      <MiddleColumn>
        <BodyCopy>
          <b>
            ...
            <em>Comte de Monte Cristo</em> ne se d&eacute;solent pas et que les
        ...
        <BodyCopy>
          ...
          ont fourni la mati&egrave;re d&rsquo;un grand nombre de films &ndash;
          et d&rsquo;ailleurs aucun livre n&rsquo;a &eacute;t&eacute; plus
          adapt&eacute; au cin&eacute;ma que ce dernier. &Agrave; la mort de
          l&rsquo;auteur, Victor Hugo &eacute;crivait : &laquo;&nbsp;Le nom
          d&apos;Alexandre Dumas est plus que fran&ccedil;ais, il est
          europ&eacute;en&nbsp;; il est plus qu&apos;europ&eacute;en, il est
          universel. Son th&eacute;&acirc;tre a &eacute;t&eacute; affich&eacute;
          dans le monde entier&nbsp;; ses romans ont &eacute;t&eacute; traduits
          dans toutes les langues. &raquo;&nbsp; Le cin&eacute;ma a
          prolong&eacute; ses succ&egrave;s. L&rsquo;&eacute;tendue temporelle
          et spatiale des adaptations des aventures d&rsquo;Edmond Dant&egrave;s
          est sans commune mesure&nbsp;: France, Italie, &Eacute;tats-Unis,
          Allemagne, Mexique, Argentine, Union sovi&eacute;tique, &Eacute;gypte,
          Inde, Cor&eacute;e du Sud, Hong Kong&hellip; rares sont les pays qui
        ...
        <BodyCopy>
          ...
          et vice versa. D&egrave;s les d&eacute;buts du cin&eacute;matographe,
          et alors que les films ne durent qu&rsquo;une quinzaine de minutes,
          les cin&eacute;astes se tournent vers ce monument de la
          litt&eacute;rature. En janvier 1908, sur la plage de Laguna Beach en
          Californie, Francis Boggs tourne les sc&egrave;nes
          ...
          bas&eacute;e &agrave; Los Angeles. <em>The Count of Monte Cristo,</em>{" "}
        ...
        <BodyCopy>
          ...
          droits d&rsquo;adaptation du roman et a produit une version de 69
          minutes (dur&eacute;e exceptionnelle pour l&rsquo;&eacute;poque),
          r&eacute;alis&eacute;e par un autre pionnier du cin&eacute;ma&nbsp;:
          Edwin S. Porter&nbsp;; il fait retirer le film de Selig de la
          circulation. <em>The Count of Monte Cristo </em>
          ...
          parce que son adaptation au th&eacute;&acirc;tre rencontrait alors un
          succ&egrave;s consid&eacute;rable aux &Eacute;tats-Unis. Pour incarner
          le r&ocirc;le principal, il avait embauch&eacute; James O&rsquo;Neill,
          acteur d&rsquo;origine irlandaise qui, par sa fid&eacute;lit&eacute;
          au roman de Dumas m&eacute;rite qu&rsquo;on s&rsquo;y attarde. En 1883
          &agrave; New York, James O&rsquo;Neill remplace au pied lev&eacute;
          l&rsquo;acteur principal d&rsquo;un Monte Cristo qui ne rencontrait
          alors qu&rsquo;un succ&egrave;s mod&eacute;r&eacute;&nbsp;; le public
          l&rsquo;adore ; il passera sa vie &ndash; plus de 6000
          repr&eacute;sentations en 40 ans &ndash; dans la peau d&rsquo;Edmond
          Dant&egrave;s. Il mourut millionnaire et c&eacute;l&eacute;brissime,
        ...
        <BodyCopy>
          ...
          &eacute;tait jou&eacute; par Charles Krauss &ndash; interpr&egrave;te,
          au d&eacute;but des ann&eacute;es 1910, du policier &agrave; la
          poursuite de Zigomar, grand criminel contemporain de Fant&ocirc;mas,
          dont la post&eacute;rit&eacute; est assur&eacute;e par Denis
          Podalyd&egrave;s et son bateau, dans{" "}
        ...
        <BodyCopy>
          ...
          coude avec le film impressioniste de Henri Fescourt, de 1929)&nbsp;;
          la deuxi&egrave;me, dans laquelle Edmond Dant&egrave;s est
        ...
        <BodyCopy>
          ...
          r&eacute;cits au long cours. &Agrave; partir de 1968, en France,
          ...
          aventures d&rsquo;Edmond Dant&egrave;s continuent d&rsquo;attirer les
          foules dans les salles obscures du monde entier.{" "}
          ...
          France, il aura fallu attendre jusqu&rsquo;au 28 juin 2024 pour revoir
          Edmond Dant&egrave;s sur le grand &eacute;cran. Au vu des foules qui
          ont rempli les salles ces derni&egrave;res semaines (le film comptait
          plus de 2 millions de spectateurs 10 jours apr&egrave;s sa sortie), on
          peut parier que le film de Delaporte et De La Patelli&egrave;re a
          r&eacute;veill&eacute; l&rsquo;app&eacute;tit du public pour cette
          histoire in&eacute;puisable.
        </BodyCopy>
      </MiddleColumn>
    </ArticleLayout>
  );
