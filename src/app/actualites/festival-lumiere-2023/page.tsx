    ...
    <>
      ...
      <div className="pt-15px lg:grid lg:auto-rows-max lg:grid-cols-[1fr_2fr] lg:pl-20px">
        ...
        <TextCell>
          ...
          <i className="italic">Harry Potter et le Prisonnier d&apos;Azkaban</i>{" "}
          ...
          <ImageAndCaption
            ...
            caption={
              <>
                ...
                <i className="italic">Charles mort ou vif</i> d&apos;Alain
                Tanner avec Thierry Frémaux.
        ...
        <TextCell>
          ...
          Une invitation à envisager différemment sa propre œuvre&nbsp;?
          <br />
          <br />
          ...
          permettent de tisser entre eux. Ainsi ne peut-on pas s&apos;empêcher
          de rapprocher les films du réalisateur indien de la{" "}
          <i className="italic">Femme dans le vent</i> d&apos;Ozu tant toutes
          ces œuvres semblent profondément mues par des préoccupations analogues
          au néoréalisme européen tout en assumant pleinement un penchant
        ...
        <TextCell>
          ...
          demeure cependant relativement peu connu en France et revoir certains
          de ses films permet de mesurer combien Altman est resté, sans doute
          plus que ses pairs (Coppola, Spielberg ou Scorsese), un réalisateur
          irréductiblement américain. Les quatre de ses films qu&apos;on a vus à
          Lyon montrent déjà les différents bouts par lesquels il a cherché à
          analyser ce pays&nbsp;: Hollywood (
          <i className="italic">The Player</i>) et plus généralement Los Angeles
          (<i className="italic">Short Cuts</i>), la Grande Dépression (
          <i className="italic">Nous sommes tous des voleurs</i>) et la conquête
          de l&apos;ouest (<i className="italic">John McCabe</i>).
        </TextCell>
        <ImageCell>
          <ImageAndCaption
            image={altman}
        ...
        <TextCell>
          ...
          Récit de fondation, <i className="italic">John McCabe</i> fait état
          d&apos;un désenchantement immédiat. Le personnage apparaît au début du
          film comme l&apos;incarnation de la figure charismatique et
