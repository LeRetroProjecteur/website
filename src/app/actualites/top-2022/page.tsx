      ...
      <MiddleColumn>
        <Section>
          <BodyCopy>
            ...
            , elle a aussi été riche en découvertes d&apos;œuvres moins connues
            (comme le merveilleux{" "}
        ...
        <Section>
          ...
          <BodyCopy>
            ...
            est un film qui a pour sujet le fait-même de se faire des films. Qui
            plus est : une bonne partie du récit se déroule carrément dans un
            cinéma (porno)&nbsp;! La réalisatrice nous plonge dans une ambiance
        ...
        <Section>
          ...
          <BodyCopy>
            ...
            géniale. Dans un étrange mélange d&apos;anarchisme post-68ard et de
            dandysme, et au fil de longues scènes dialoguées à la mise en scène
            sèche, Eustache explore les impasses d&apos;une révolution sexuelle
            en train de se faire. Le format minimaliste de l&apos;image, proche
            du carré, rendait paradoxalement l&apos;expérience cinéma (au
            premier rang d&apos;une salle bondée en pleine canicule)
        ...
        <Section>
          ...
          <BodyCopy>
            ...
            contemporain. Poil à gratter jusque dans sa mise en scène,
            Fassbinder fonde l&apos;un de ses plus beaux films,{" "}
            <Link className="underline" href="/film/lola-femme-allemande-1981">
              <i>Lola, une femme allemande</i>
            </Link>
            , sur un magnifique contrepied en nichant dans une légère comédie de
            mœurs un véritable brûlot politique au cynisme dévorant.
          </BodyCopy>
        </Section>
        <Section>
          <MiddleColumnImageAndTitle
          ...
          <BodyCopy>
            ...
            par l&apos;omniprésence de thèmes en lien avec le christianisme dans
            son œuvre. Son traitement de ceux-ci peut relever aussi bien de la
            ...
            , le déplacement des représentations habituelles de scènes bibliques
        ...
        <Section>
          ...
          <BodyCopy>
            ...
            rendant nostalgique de souvenirs qu&apos;elle ne vivra jamais.
            Revoir{" "}
            <Link className="underline" href="/film/la-derniere-seance-1971">
              <i>La Dernière séance</i>
            </Link>{" "}
            dans une salle de cinéma à l&apos;heure où les oiseaux de mauvais
            augure nous prédisent les “dernières séances” de celles-ci, donne au
            film une épaisseur toute particulière...
          </BodyCopy>
        </Section>
        <Section>
          <MiddleColumnImageAndTitle
          ...
          <BodyCopy>
            ...
            pendant tout le film, mais c&apos;est surtout le cynisme du final
            que l&apos;on garde en tête, tant il n&apos;avait rien à envier à
            celui de l&apos;exercice électoral auquel on s&apos;était soumis
        ...
        <Section>
          <MiddleColumnImageAndTitle
            ...
            title={
              <>
                <Link className="underline" href="/film/adieu-au-langage-2014">
