...
export default function Footer() {
  return (
    <div className="border-retro-gray flex grow flex-col gap-3 border-t pt-3 lg:h-[141px] lg:pt-2">
      <div className="text-retro-gray flex flex-col gap-7 text-xl font-medium uppercase leading-6 lg:grow lg:justify-between">
