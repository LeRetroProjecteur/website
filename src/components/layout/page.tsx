...
export function ThreeColumnPage({
  ...
  return (
    <div className="mx-auto my-0 block w-full max-w-[90vw] grow px-3 sm:max-w-[32rem] sm:px-4 wide-article:max-w-[37.5rem] lg:m-0 lg:grid lg:max-w-none lg:grid-cols-[0_32rem_1fr] lg:pl-20px 3col:grid-cols-[minmax(13rem,_1fr)_minmax(30rem,_40rem)_minmax(13rem,_1fr)] 3col:pl-0">
      {header && (
        <>
