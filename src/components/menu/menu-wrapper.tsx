  ...
  return (
    <>
      <div className="relative lg:static lg:flex lg:items-start">
        <motion.div
          className="lg:p-20px absolute left-0 z-10 hidden min-h-screen w-full bg-white lg:sticky lg:top-0 lg:flex lg:w-max lg:pr-0"
          animate={
        ...
        <motion.div
          className="px-20px absolute left-0 flex min-h-screen w-full grow lg:static lg:pl-0"
          transition={{
            duration: wasMenuOpen.current !== isMenuOpen ? 0.2 : 0,
          }}
          animate={
